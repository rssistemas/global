<?php
class tipoClasificacionModel  extends model
{
    ...
    public function listar($nivel = false,$ref=false)
    { 
		if($ref)
		{	
			if($nivel)
			{
				$sql = "select * from tipoclasificacion"
				. " where nombre_tipo_clasificacion like '%$ref%' and nivel_tipo_clasificacion='$nivel'
				order by nombre_tipo_clasificacion ASC";
			}
			else
			{
				$sql = "select * from tipoclasificacion"
				. " where nombre_tipo_clasificacion like '%$ref%' order by nombre_tipo_clasificacion ASC";
			}
		}else
		{
			if($nivel)
			{
				$sql = "select * from tipoclasificacion"
				. " where nivel_tipo_clasificacion='$nivel'	order by nombre_tipo_clasificacion ASC";
			}
			else
			{
				$sql = "select * from tipoclasificacion order by nombre_tipo_clasificacion ASC";
			}
    ...
    {
        $sql = "select * from tipoclasificacion where id_tipo_clasificacion = '$id'";
        $res = $this->_db->query($sql);
        if($res)
        {
            $res->setFetchMode(PDO::FETCH_ASSOC);
    ...
    {
        $sql = "select * from tipo_documento where accion = 'SALIDA'";
        $res = $this->_db->query($sql);
        if($res)
        {
            $res->setFetchMode(PDO::FETCH_ASSOC);
